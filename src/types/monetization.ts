 ...
 */
export const ACTION_TO_USAGE_FIELD_MAP: Record<Action | string, UsageField> = {
  ...
  'campaigns_generated': USAGE_FIELDS.CAMPAIGNS_GENERATED,
} as const;
...
export const FEATURE_TO_USAGE_FIELD_MAP: Record<FeatureId, UsageField> = {
  ...
  [FEATURES.SCRIPT_GENERATION]: USAGE_FIELDS.CAMPAIGNS_GENERATED, // Script generation uses campaigns counter now
